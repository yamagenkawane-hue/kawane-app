...
insert into public.tmp_seed_posts (
  ...
  (gen_random_uuid(), 'TEST-ORD-006', 'TEST-P101', 180, '2026-09-09', '2026-09-12', '同一得意先・同一製品グループ表示の確認用'),
  (gen_random_uuid(), 'TEST-ORD-007', 'TEST-P101', 220, '2026-09-10', '2026-09-13', '同一得意先・同一製品グループ表示の確認用'),
