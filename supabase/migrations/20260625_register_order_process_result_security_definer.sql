-- Allow the result-registration RPC to write production_results/order_processes
-- even when RLS is enabled. The function still validates the target process,
-- locked state, and allowed quantity before writing.
