-- Soft-delete one order and remove related workflow records by post_id/order_no.
-- This intentionally does not match by product_name, because the same product
-- name can appear on different order numbers.
