-- Align v_posts_with_master outsource status with the application rule:
-- an outsource-capable process is not "外注" until it has been sent,
-- returned, or completed as an outsource result.
