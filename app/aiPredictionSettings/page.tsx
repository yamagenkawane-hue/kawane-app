...
type EvaluationDetail = { id: string; order_no: string; predicted_completion_date: string; legacy_completion_date: string | null; actual_completion_date: string; business_day_error: number; lead_business_days: number; created_at: string };
